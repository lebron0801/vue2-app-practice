 ...
 * @param url 上传地址
 */
export const singleUpload = (file: File, data: Record<string, any>, onProgress: Function, url: string) => {
	return postFile(
		Object.assign(
			{
				file: file
 ...
 */
export async function splitUpload(file: any, data: any, onProgress: Function, url: string, eachSize: number) {
	try {
